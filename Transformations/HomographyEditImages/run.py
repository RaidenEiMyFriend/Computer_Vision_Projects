...
cv_desk = img_as_float(io.imread('1.jpg')[:,:,:3])
cv_desk_gray = rgb2gray(cv_desk)
cv_cover_temp = img_as_float(io.imread('res-1.jpg')[:,:,:3])
cv_cover = rgb2gray(cv_cover_temp)
hp_cover = img_as_float(io.imread('2.jpg'))
